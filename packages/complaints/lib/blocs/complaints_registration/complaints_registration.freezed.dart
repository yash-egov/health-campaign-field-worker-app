...
class _$ComplaintsRegistrationSaveComplaintDetailsEventImpl
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.complaintsDetailsModel, complaintsDetailsModel) &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(complaintsDetailsModel),
      boundaryModel);
...
class _$ComplaintsRegistrationViewStateImpl
  ...
  @override
  int get hashCode => Object.hash(runtimeType, complaintType, addressModel,
      const DeepCollectionEquality().hash(complaintsDetailsModel));
